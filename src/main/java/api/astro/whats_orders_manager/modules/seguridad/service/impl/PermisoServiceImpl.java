...
public class PermisoServiceImpl implements PermisoService {
    ...
    @Override
    public List<api.astro.whats_orders_manager.modules.seguridad.model.Permiso> obtenerTodosActivos() {
        log.debug("Obteniendo todos los permisos activos desde BD");
        return permisoRepository.findByActivoTrue();
    }
    
    @Override
    public List<api.astro.whats_orders_manager.modules.seguridad.model.Permiso> obtenerTodos() {
        log.debug("Obteniendo todos los permisos desde BD");
        return permisoRepository.findAll();
    }
    
    @Override
    public Optional<api.astro.whats_orders_manager.modules.seguridad.model.Permiso> buscarPorCodigo(String codigo) {
        log.debug("Buscando permiso por código: {}", codigo);
        return permisoRepository.findByCodigo(codigo);
    }
    
    @Override
    public Optional<api.astro.whats_orders_manager.modules.seguridad.model.Permiso> buscarPorId(Long id) {
        log.debug("Buscando permiso por ID: {}", id);
        return permisoRepository.findById(id);
    }
    
    @Override
    public api.astro.whats_orders_manager.modules.seguridad.model.Permiso guardar(api.astro.whats_orders_manager.modules.seguridad.model.Permiso permiso) {
    ...
    public boolean tienePermisoPorCodigo(String username, String codigoPermiso) {
        ...
        try {
            ...
            Set<api.astro.whats_orders_manager.modules.seguridad.model.Permiso> permisosRol = new HashSet<>();
