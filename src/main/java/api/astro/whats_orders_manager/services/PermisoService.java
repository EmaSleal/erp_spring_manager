...
public interface PermisoService {
     ...
     */
    List<api.astro.whats_orders_manager.models.Permiso> obtenerTodosActivos();
    
    /**
     * Obtiene todos los permisos (incluyendo inactivos) desde la BD
     */
    List<api.astro.whats_orders_manager.models.Permiso> obtenerTodos();
    
    /**
     * Busca un permiso por su código
     */
    Optional<api.astro.whats_orders_manager.models.Permiso> buscarPorCodigo(String codigo);
    
    /**
     * Busca un permiso por su ID
     */
    Optional<api.astro.whats_orders_manager.models.Permiso> buscarPorId(Long id);
    
    /**
     * Guarda o actualiza un permiso en la BD
     */
    api.astro.whats_orders_manager.models.Permiso guardar(api.astro.whats_orders_manager.models.Permiso permiso);
