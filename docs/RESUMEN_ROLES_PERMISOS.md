...
| Rol | Permisos | Nivel de Acceso | Descripción | Casos de Uso |
|-----|----------|-----------------|-------------|--------------|
| **ADMIN** | 48 | ⚫ Total | Acceso completo al sistema | Administradores, propietarios del negocio |
| **GERENTE** | 30 | 🔴 Alto | Gestión completa de operaciones | Gerentes de área, supervisores |
| **VENDEDOR** | 15 | 🟠 Medio | Operaciones básicas de venta | Personal de ventas, cajeros |
| **USER** | 10 | 🟡 Básico | Usuario básico con permisos limitados | Empleados generales |
| **VISUALIZADOR** | 8 | 🟢 Solo Lectura | Acceso de consulta sin modificación | Analistas, auditores externos |
| **CLIENTE** | 3 | 🔵 Externo | Solo consulta de facturas propias | Clientes del negocio |
...
## 🔒 PERMISOS CRÍTICOS (Solo ADMIN)

### Categorías Exclusivas de ADMIN

| Categoría | Permisos | Razón |
|-----------|----------|-------|
| **USUARIOS** | 8 permisos | Gestión de usuarios es crítica para seguridad |
| **AUDITORÍA** | 2 permisos | Acceso a logs completos del sistema |
| **SISTEMA** | 3 permisos | Operaciones técnicas sensibles |

### Permisos Críticos Individuales

| Permiso | Categoría | Razón |
|---------|-----------|-------|
| `FACTURA_ELIMINAR` | Facturación | Elimina datos financieros |
| `FACTURA_ANULAR` | Facturación | Anula transacciones completadas |
| `CONFIG_EDITAR_EMPRESA` | Configuración | Modifica datos legales de la empresa |
| `NOTIFICACION_ELIMINAR` | Notificaciones | Elimina registros del sistema |

**Total Permisos Críticos:** 19
...
### Escenario 1: Tienda Pequeña (1-3 empleados)
- **Propietario:** ADMIN
- **Empleados:** VENDEDOR

### Escenario 2: Tienda Mediana (4-10 empleados)
- **Propietario:** ADMIN
- **Gerente de Tienda:** GERENTE
- **Vendedores:** VENDEDOR
- **Personal Temporal:** USER

### Escenario 3: Tienda Grande (10+ empleados)
- **Propietario/IT:** ADMIN
- **Gerente General:** GERENTE
- **Supervisores:** GERENTE
- **Vendedores Senior:** VENDEDOR
- **Vendedores Junior:** USER
- **Contador/Auditor:** VISUALIZADOR
- **Portal Clientes:** CLIENTE

### Escenario 4: Franquicia/Multi-Sucursal
- **Corporativo:** ADMIN
- **Gerente de Sucursal:** GERENTE
- **Vendedores:** VENDEDOR
- **Auditoría Corporativa:** VISUALIZADOR
- **Portal Clientes B2B:** CLIENTE
